...
import { EpicsList, EpicsSkeleton, EmptyEpics } from "@/features/epics";
...
const EpicsPage = () => {
	...
	const { epics, isLoading, error, getEpicsByProjectId, handleCreateRedirect } = useEpicsPage({ projectId });
	...
	return (
		<main>
			...
			<EpicsList epics={epics} onCreateEpic={handleCreateRedirect} />
		</main>
	);
};
